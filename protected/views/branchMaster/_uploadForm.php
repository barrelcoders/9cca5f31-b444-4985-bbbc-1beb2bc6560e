...
Yii::app()->clientScript->registerScript(
   'validatePlayerForm',
   '$("#branch-master-upload-form").submit(function(e){
		var validate=true,
	...
	<div class="form-row control-group row-fluid">
		<div class="form-horizontal span6">
			<div class="form-row control-group row-fluid fluid">
				<label>Branch Master File</label>
			...
			<div class="form-row control-group row-fluid fluid">
				<?php if(isset($this->importStatus)){?>
					<table style="width:100%;">
						<tr>
							<th>Upload BranchMaster Status</th>
						</tr>	
		...
		<div class="form-horizontal span12">
			<div class="form-row control-group row-fluid fluid">
				<div>
					...
					<div style="overflow:auto;"><img src="images/excel_snapshots/branch_master.png"/></div>
				</div>
			</div>
		</div>
	</div>
