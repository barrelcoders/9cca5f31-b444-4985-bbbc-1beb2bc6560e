...
class DepartureController extends Controller {
    ...
    public function actionCreate($arrival) {
        ...
        if (isset($_POST['Departure'])) {
			...
			if(($_POST['Departure']['to_departure']=='Train' || $_POST['Departure']['to_departure']=='Bus' || $_POST['Departure']['to_departure']=='Flight') && $_POST['Departure']['vehicle_required']=='Yes'){
				$model->transportOrSurface = 'Transport';
            }
			else if(($_POST['Departure']['to_departure']=='Train' || $_POST['Departure']['to_departure']=='Bus' || $_POST['Departure']['to_departure']=='Flight') && $_POST['Departure']['vehicle_required']=='No'){
				$model->transportOrSurface = 'Transport';
            }
			else if($_POST['Departure']['to_departure']=='Surface' && $_POST['Departure']['vehicle_required']=='Yes'){
				$model->transportOrSurface = 'Transport';
            }
			else if($_POST['Departure']['to_departure']=='Surface' && $_POST['Departure']['vehicle_required']=='No'){
            ...
            if ($model->save(false)) {
                ...
                if ($_POST['Departurevehicle']) {
                    ...
                    for ($i = 1; $i < sizeof($_POST['Departurevehicle']['vehicle_id_fk']); $i++) {
                        for ($j = 1; $j <= intVal($_POST['Departurevehicle']['noOfVehicle'][$i]); $j++) {
                            ...
                            $modelArrivalVehicle->vehicle_id_fk = $_POST['Departurevehicle']['vehicle_id_fk'][$i];
                            $modelArrivalVehicle->dept_id_fk = $model->id;
							$modelArrivalVehicle->nameOfVehicle = VehicleMaster::model()->findByPK($_POST['Departurevehicle']['vehicle_id_fk'][$i])->name;
    ...
    public function actionTrainNumberArrivalTime() {
        ...
        if ($_POST['val'] == "Other") {
            ...
            echo $model->number . "," . $model->arrival_time.", ".Places::model()->findByPK($model->to)->name;
            exit;
        }
    }
    ...
    public function actionBusNumberArrivalTime() {
        ...
        if ($_POST['val'] == "Other") {
            ...
            echo $model->arrival_time.", ".Places::model()->findByPK($model->to)->name;
            exit;
        }
    }
