...
class FlightMasterController extends Controller {
	...
	public function actionAjaxCreateMini()
	{
		...
		if(isset($_GET['name']) && isset($_GET['short_code'])  && isset($_GET['branch_id_fk']) && isset($_GET['hours'])
			&& isset($_GET['minutes']) && isset($_GET['to']) && isset($_GET['from']))
		{
			...
			$model->arrival_time= $_GET['hours'].":".$_GET['minutes'];  
